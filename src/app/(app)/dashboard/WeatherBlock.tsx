  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
        ...
        {latest?.date && (
          <span style={{ fontSize: 10, color: '#3a5240', marginLeft: 'auto' }}>
      ...
      {!latest ? (
        ...
        <>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
            ...
            <span style={{ fontSize: 16, fontWeight: 600, color: '#535c3e', fontFamily: 'var(--font-mono)' }}>
              / {fmtVal(latest.temp_min, 0)}°
            </span>
            {latest.temp_max != null && latest.temp_min != null && (
              <span style={{ fontSize: 11, color: '#535c3e', marginLeft: 4 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
            {[
              { Icon: Droplets, label: 'Umidade',  value: fmtVal(latest.humidity_percent, 0), unit: '%',    color: '#06b6d4' },
              { Icon: Wind,     label: 'Vento',    value: fmtVal(latest.wind_speed_ms),       unit: 'm/s',  color: '#7a9e82' },
              ...
              <div key={label} style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                  ...
                  <span style={{ fontSize: 9, color: '#3a5240', textTransform: 'uppercase', letterSpacing: '0.06em' }}>
                    {label}
                  </span>
                </div>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 3 }}>
                  ...
                  <span style={{ fontSize: 10, color: '#535c3e' }}>{unit}</span>
                </div>
              </div>
            ))}
          </div>
